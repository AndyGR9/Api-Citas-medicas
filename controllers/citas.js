...
const citasPOST=async(req=request, res=response)=>{
    ...
    const {nombre,apellido,telefono,fecha,especialidad,medico}=req.body
    

    const cita= new Citas({nombre,apellido,telefono,fecha,especialidad,medico});

    cita.fecha = moment(fecha).toISOString()
